...
class MainViewController: UIViewController {
  ...
  var centerCell: CarouselCollectionViewCell?
    let carouselItems = [("1", UIColor(red: 1, green: 0, blue: 0, alpha: 1)),("2", UIColor(red: 0, green: 1, blue: 0, alpha: 1)), ("3", UIColor(red: 0, green: 0, blue: 1, alpha: 1)), ("4", UIColor.systemPink)]
