...
class RectangleBarChart: UIView {
    ...
    private let presenter = RectangleBarChartPresenter(barWidth: 40, space: 20)
    ...
    private var barEntries: [RectangleBarEntry] = [] {
        didSet {
    ...
    private func showEntry(index: Int, entry: RectangleBarEntry, animated: Bool, oldEntry: RectangleBarEntry?) {
