...
class CurveBarChart: UIView {
    private let mainLayer: CALayer = CALayer()
    private let scrollView: UIScrollView = UIScrollView()
    
    private let presenter = CurveBarChartPresenter(barWidth: 140, space: -70)
    
    private var animated: Bool = false
    
    private var barEntries: [CurveBarEntry] = [] {
        didSet {
    ...
    private func showEntry(index: Int, barEntry: CurveBarEntry, animated: Bool, oldEntry: CurveBarEntry?) {
